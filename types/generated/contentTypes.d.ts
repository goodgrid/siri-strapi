...
export interface ApiAvatarAvatar extends Schema.SingleType {
...
export interface ApiContactDetailContactDetail extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    emailadres: Attribute.String;
    locatie: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Attribute.DateTime;
    telefoonnummer: Attribute.String;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::contact-detail.contact-detail',
      'oneToOne',
...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    typeAndSubtype: Attribute.Enumeration<
      [
        'work',
        'work_sold',
        'work_commisioned',
...
export interface ApiStoryStory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    work: Attribute.Relation<'api::story.story', 'oneToOne', 'api::work.work'>;
  };
}
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    story: Attribute.Relation<'api::work.work', 'oneToOne', 'api::story.story'>;
